...
export default function NyOrdrePage() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f6] flex items-center justify-center">
      <div className="max-w-lg w-full mx-4">
        <div className="mb-6">
          <Link href="/ordrer" className="text-sm text-gray-500 hover:text-[#d4a373] transition">&larr; Tilbage til ordrer</Link>
        </div>
        <div className="bg-white border border-[#e8e6e1] rounded-xl p-8">
          <h1 className="text-xl font-bold text-[#1a1a2e] mb-6">Ny ordre</h1>
